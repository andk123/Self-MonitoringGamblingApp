...
public class SessionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        super.onCreate(savedInstanceState);
        ViewGroup view = (ViewGroup)inflater.inflate(R.layout.fragment_sessions, container, false);
        ListView listView = (ListView) view.findViewById(R.id.sessionsList);
        DatabaseHelper dbHelper = new DatabaseHelper(FirebaseDatabase.getInstance().getReference());
        dbHelper.fetchDataAndDisplayList(getActivity(),listView);
